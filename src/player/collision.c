...
/*   Updated: 2024/09/13 21:10:11 by tunsal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (is_pos_walkable(g, vec2d_mult_by_scalar(&mv_dir, WALK_SPEED), 0)
		&& is_pos_walkable(g, vec2d_mult_by_scalar(&mv_dir, WALK_SPEED), 55)
		&& is_pos_walkable(g, vec2d_mult_by_scalar(&mv_dir, WALK_SPEED), -55))
		return (1);
	return (0);
}
